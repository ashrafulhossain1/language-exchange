        ...
        <div>
            ...
            <div>
                <div className="flex justify-center items-center md:min-h-screen bg-gradient-to-br from-gray-100 to-blue-50 py-8">
                    {/* Form Container */}
                    <div className="card w-full max-w-lg p-8 dark:bg-black  bg-white shadow-2xl rounded-xl border-t-4 border-purple-500">
                        ...
                        <form onSubmit={handleSignUp} className="space-y-1">
                            ...
                            <div className="form-control">
                                <label className="dark:text-white my-1 label font-medium text-gray-700">
                                    <span>Name</span>
                                </label>
                                <input
                                    name="name"
                        ...
                        {/* Sign In Link */}
                        <p className="text-center dark:text-white text-sm text-gray-600 mt-2">
