...
const SignIn = () => {
    ...
    return (
        <div>
            ...
            <div>
                <div className="flex justify-center items-center  dark:bg-black py-4 md:min-h-screen bg-gradient-to-br from-gray-100 to-blue-50">
                    {/* Form Container */}
                    <div className="card w-full max-w-md p-8 dark:bg-black/80 dark:text-white bg-white shadow-2xl rounded-xl border-t-4 border-purple-500">
                        ...
                        <form onSubmit={handleSignIn} className="space-y-5">
                            ...
                            <div className="form-control">
                                <label className="label font-medium dark:text-white text-gray-700">
                                    <span>Email</span>
                                </label>
                                <input
                                    name="email"
                                    ...
                                    className="input dark:text-black input-bordered w-full border-gray-300 focus:ring-2 focus:ring-blue-400 rounded-lg"
                                    required
                                />
                            </div>
                            {/* Password Input */}
                        ...
                        {/* social sign in */}
                        <p className="text-center text-sm dark:text-white text-gray-600 mt-2">
