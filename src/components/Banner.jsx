        ...
        <SwiperSlide>
          <div className="relative h-[250px] sm:h-[400px] md:h-[65vh]">
            ...
            <img
              ...
              src="https://i.ibb.co.com/5hvJNYR6/focused-students-using-tablet-discussing-information-1262-14929.jpg"
              alt="Language Tutors"
            />
            {/* Content */}
            <div className="absolute top-1/2 left-6 sm:left-10 transform -translate-y-1/2 z-30 text-white px-4 w-full md:w-5/12 user-select">
              ...
              <button className="mt-4 px-6 py-2 border border-[#738c4c] 
              text-white hover:text-white hover:border-none hover:bg-[#2F4021]  transition-all duration-300">
